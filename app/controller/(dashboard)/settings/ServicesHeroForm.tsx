...
import { updateServicesHero, type SettingsFormState } from "./actions";
import type { ServicesHero } from "@/lib/data/settings";

const initialState: SettingsFormState = { error: null, success: false };

export default function ServicesHeroForm({ values }: { values: ServicesHero }) {
  ...
  return (
    ...
    >
      <h2 className="font-display text-lg text-navy">Services page hero</h2>
      <p className="text-sm text-gray-500">
        The full-screen banner at the top of the Services listing page
        (/services). Individual service pages are managed on the Services
        page in the sidebar — their hero text color is set separately below.
      </p>

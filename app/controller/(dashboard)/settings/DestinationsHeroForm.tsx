...
import { updateDestinationsHero, type SettingsFormState } from "./actions";
import type { DestinationsHero } from "@/lib/data/settings";

const initialState: SettingsFormState = { error: null, success: false };

export default function DestinationsHeroForm({
  values,
}: {
  values: DestinationsHero;
}) {
  const [state, formAction, pending] = useActionState(
    updateDestinationsHero,
    initialState,
  );
  ...
  return (
    ...
    >
      <h2 className="font-display text-lg text-navy">Destinations page hero</h2>
      <p className="text-sm text-gray-500">
        The full-screen banner at the top of the Destinations page.
      </p>

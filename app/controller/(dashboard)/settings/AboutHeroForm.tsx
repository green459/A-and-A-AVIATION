...
import { updateAboutHero, type SettingsFormState } from "./actions";
import type { AboutHero } from "@/lib/data/settings";

const initialState: SettingsFormState = { error: null, success: false };

export default function AboutHeroForm({ values }: { values: AboutHero }) {
  ...
  return (
    ...
    >
      <h2 className="font-display text-lg text-navy">About page hero</h2>
      <p className="text-sm text-gray-500">
        The full-screen banner at the top of the About page.
      </p>

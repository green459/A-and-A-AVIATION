...
import { updateRefundPolicy, type SettingsFormState } from "./actions";
import type { RefundPolicyContent } from "@/lib/data/settings";
...
export default function RefundPolicyForm({
  ...
  return (
    ...
    >
      <h2 className="font-display text-lg text-navy">Refund Policy page</h2>
      ...
      <label className="flex items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-4 py-3 text-sm font-medium text-gray-700">
        ...
        <span className="font-normal text-gray-500">
          — when off, /refund-policy returns 404 and it&apos;s hidden from
          the contact form&apos;s agreement text.
        </span>
      </label>
      ...
      >
        {pending ? "Saving…" : "Save refund policy"}
      </button>
    </form>
  );
}

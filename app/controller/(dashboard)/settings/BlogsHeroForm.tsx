...
import { updateBlogsHero, type SettingsFormState } from "./actions";
import type { BlogsHero } from "@/lib/data/settings";

const initialState: SettingsFormState = { error: null, success: false };

export default function BlogsHeroForm({ values }: { values: BlogsHero }) {
  ...
  return (
    ...
    >
      <h2 className="font-display text-lg text-navy">Blogs page hero</h2>
      <p className="text-sm text-gray-500">
        The full-screen banner at the top of the Blogs page.
      </p>
